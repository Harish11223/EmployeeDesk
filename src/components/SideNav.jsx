...
const navItems = [
    { text: 'Dashboard', path: '/admindash', icon: <img src={DashboardIcon} alt="Dashboard" style={{ width: 24, height: 24 }} /> },
    { text: 'Employees', path: '/employees', icon: <PeopleAltIcon /> },
    { text: 'Add Employee', path: '/newuser', icon: <PersonAddIcon /> },
    { text: 'Attendance Report', path: '/attendance-report', icon: <AssessmentIcon /> },
    { text: 'Leave Management', path: '/leave-management', icon: <ExitToAppIcon /> },
    { text: 'Salary Management', path: '/salary-management', icon: <CurrencyRupeeIcon /> },
];
...
export default function Sidebar() {
    ...
    const fetchEmployeeData = async () => {
        try {
            ...
            const docRef = doc(firestore, 'Admin', user.uid);
    ...
    const handleNavigation = (path) => {
        expanded
            ? setExpanded(true)   // Explicitly keep expanded
            : setExpanded(false); // Explicitly keep collapsed
